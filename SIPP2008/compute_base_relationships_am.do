...
program define compute_relationships
    ...
    keep SSUID SHHADID SWAVE panelmonth relfrom relto relationship_tc0 reason_tc0
...
********************************************************************************
** Section: Find pairs for which we have more than one relationship type in a single panelmonth.
...
*reshape so that we can compare relationships for pairs (within panelmonth) with more than one relationship type
